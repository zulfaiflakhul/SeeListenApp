...
class BelajarAeFragment : Fragment() {

    private var belajarMengingatFragmentBinding : FragmentBelajarAeBinding? = null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        belajarMengingatFragmentBinding = binding

        val args = this.arguments

        val alfabet = listOf("A","B","C","D","E")
        val image = listOf(
            R.drawable.img_sibi_a,
            R.drawable.img_sibi_b,
            R.drawable.img_sibi_c,
            R.drawable.img_sibi_d,
            R.drawable.img_sibi_e)
        val video = listOf(
            "android.resource://${activity?.packageName}/${R.raw.a}" ,
            "android.resource://${activity?.packageName}/${R.raw.b}" ,
            "android.resource://${activity?.packageName}/${R.raw.c}" ,
            "android.resource://${activity?.packageName}/${R.raw.d}" ,
            "android.resource://${activity?.packageName}/${R.raw.e}"
        )
        ...
        binding.selanjutnyaButton.setOnClickListener {
            ...
            if (count == 6){
                ...
                binding.titleKeteranganFinishTv.text = "Anda telah mengenal huruf A-E"
        ...
        if (pilihan != null){
            ...
            binding.selanjutnyaButton2.setOnClickListener {
                ...
                if (count == 10) {
                    ...
                    binding.finishLayout.visibility = View.VISIBLE
                    binding.titleKeteranganFinishTv.text = "Anda telah belajar huruf A-E"
