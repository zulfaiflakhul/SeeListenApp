...
class BelajarFjFragment : Fragment() {

    private var belajarAeBinding : FragmentBelajarAeBinding? = null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        belajarAeBinding = binding
        binding.titleBelajarAlfabetTv.text = "Huruf F - J"

        val args = this.arguments

        val alfabet = listOf("F","G","H","I","J")
        val image = listOf(
            R.drawable.img_sibi_f,
            R.drawable.img_sibi_g,
            R.drawable.img_sibi_h,
            R.drawable.img_sibi_i,
            R.drawable.img_sibi_j)
        val video = listOf(
            "android.resource://${activity?.packageName}/${R.raw.f}" ,
            "android.resource://${activity?.packageName}/${R.raw.g}" ,
            "android.resource://${activity?.packageName}/${R.raw.h}" ,
            "android.resource://${activity?.packageName}/${R.raw.i}" ,
            "android.resource://${activity?.packageName}/${R.raw.j}"
        )
        ...
        binding.selanjutnyaButton.setOnClickListener {
            ...
            if (count == 6){
                ...
                binding.titleKeteranganFinishTv.text = "Anda telah mengenal huruf F-J"
        ...
        if (pilihan != null){
            ...
            binding.selanjutnyaButton2.setOnClickListener {
                ...
                if (count == 10) {
                    ...
                    binding.finishLayout.visibility = View.VISIBLE
                    binding.titleKeteranganFinishTv.text = "Anda telah belajar huruf F-J"
