...
class BelajarKoFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.titleBelajarAlfabetTv.text = "Huruf K - O"

        val args = this.arguments

        val alfabet = listOf("K","L","M","N","O")
        val image = listOf(
            R.drawable.img_sibi_k,
            R.drawable.img_sibi_l,
            R.drawable.img_sibi_m,
            R.drawable.img_sibi_n,
            R.drawable.img_sibi_o)
        val video = listOf(
            "android.resource://${activity?.packageName}/${R.raw.k}" ,
            "android.resource://${activity?.packageName}/${R.raw.l}" ,
            "android.resource://${activity?.packageName}/${R.raw.m}" ,
            "android.resource://${activity?.packageName}/${R.raw.n}" ,
            "android.resource://${activity?.packageName}/${R.raw.o}"
        )
        ...
        binding.selanjutnyaButton.setOnClickListener {
            ...
            if (count == 6){
                ...
                binding.titleKeteranganFinishTv.text = "Anda telah mengenal huruf K-O"
        ...
        if (pilihan != null){
            ...
            binding.selanjutnyaButton2.setOnClickListener {
                ...
                if (count == 10) {
                    ...
                    binding.finishLayout.visibility = View.VISIBLE
                    binding.titleKeteranganFinishTv.text = "Anda telah belajar huruf K-O"
