...
class BelajarSatuFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val image = listOf(
            R.drawable.img_sibi_1,
            R.drawable.img_sibi_2,
            R.drawable.img_sibi_3,
            R.drawable.img_sibi_4,
            R.drawable.img_sibi_5
        )
        ...
        if (pilihan != null){
            ...
            binding.selanjutnyaButton2.setOnClickListener {
                ...
                if (count == 6) {
                    ...
                    binding.titleKeteranganFinishTv.text = "Anda telah belajar angka 1-5"
