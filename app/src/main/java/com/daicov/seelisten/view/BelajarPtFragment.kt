...
class BelajarPtFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.titleBelajarAlfabetTv.text = "Huruf P - T"

        val args = this.arguments

        val alfabet = listOf("P","Q","R","S","T")
        val image = listOf(
            R.drawable.img_sibi_p,
            R.drawable.img_sibi_q,
            R.drawable.img_sibi_r,
            R.drawable.img_sibi_s,
            R.drawable.img_sibi_t)
        val video = listOf(
            "android.resource://${activity?.packageName}/${R.raw.p}" ,
            "android.resource://${activity?.packageName}/${R.raw.q}" ,
            "android.resource://${activity?.packageName}/${R.raw.r}" ,
            "android.resource://${activity?.packageName}/${R.raw.s}" ,
            "android.resource://${activity?.packageName}/${R.raw.t}"
        )
        ...
        binding.selanjutnyaButton.setOnClickListener {
            ...
            if (count == 6){
                ...
                binding.titleKeteranganFinishTv.text = "Anda telah mengenal huruf P-T"
        ...
        if (pilihan != null){
            ...
            binding.selanjutnyaButton2.setOnClickListener {
                ...
                if (count == 10) {
                    ...
                    binding.finishLayout.visibility = View.VISIBLE
                    binding.titleKeteranganFinishTv.text = "Anda telah belajar huruf P-T"
